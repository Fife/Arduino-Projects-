...
/*
   ...
   This pedal has 2 overall modes that are broken down into sub modes:
     ...
     PolyMode:
        -Gridded PolyMode
          This mode make sure that when you adjust the "Poly" Element, the signal change is slightly delayed until the next cycle starts. This is so that any poly change will always be
          aligned with the master timer
        -Free PolyMode
